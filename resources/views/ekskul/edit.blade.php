                ...
                <div class="card-body">
                    <form action="{{ route('ekskul.update', $ekskul->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ekskul') is-invalid @enderror" name="ekskul"
                                value="{{ $ekskul->ekskul }}" placeholder="Ekstrakulikuler" required>
                            @error('ekskul')
